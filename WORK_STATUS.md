...
- รอผู้ดูแลตรวจแท็บ `I_จับคู่_Burger_POS`: เลือกผลเป็น `ถูกต้อง`, `แก้ไข` หรือ `ไม่ใช้`; ถ้าเลือก `แก้ไข` ให้กรอกคอลัมน์ `รหัส BOY ที่ถูกต้อง` และหมายเหตุ ก่อนนำผลกลับไปอัปเดต Mapping/หน่วยแปลงใน BOY Central
