...
- ปรับ `tawana.html` เป็น UI mobile-first ใหม่: แบ่งเมนูบันทึก/ลา/เงินเดือน/เพิ่มเติม, เมนูล่างติดขอบจอ, ตัวเลือกร้าน, สรุปยอดทันที, สถานะบันทึกร่าง และหน้าตรวจสอบก่อนส่ง
